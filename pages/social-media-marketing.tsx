...
const socialMediaMarketing = () => {
  ...
  return (
    ...
    <div className={`whats-app-icon ${scrolled ? "d-block" : "d-none"}`}> 
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> Social Media Marketing </h3>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <p>
              Social media marketing is the practice of using social media platforms to promote products, services, or content to a target audience. It involves creating and sharing engaging content, running paid advertising campaigns, and building a strong online community.
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
              Social media marketing is the practice of using social media platforms like Facebook, Instagram, Twitter, and LinkedIn to connect with your target audience, promote your products or services, and build a strong online presence. It's a dynamic and ever-evolving field that offers numerous opportunities for businesses to thrive.Social media allows you to showcase your brand to a wide audience, helping you increase brand recognition and visibility.You can engage with your audience in real-time, respond to comments, and build a loyal community around your brand.
              </p>
              <Link
                href="contact-us-1"
      ...
      <div className="service-section social-media">
