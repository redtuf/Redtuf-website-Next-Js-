...
const cloudManagedService = () => {
  ...
  return (
    ...
    <div className={`whats-app-icon ${scrolled ? "d-block" : "d-none"}`}> 
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> Cloud Managed Service </h3>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <p>
              At Redtuf, we understand that managing your cloud infrastructure can be a complex and time-consuming task. That's why we offer a comprehensive suite of Cloud Managed Services designed to streamline your operations, enhance security, and optimize costs, so you can focus on what matters most – growing your business.
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
              Our team of certified cloud experts will take care of all aspects of your cloud infrastructure. From provisioning and scaling to monitoring and optimization, we ensure your cloud environment is always performing at its best.Security is our top priority. We implement robust security measures to protect your data and applications in the cloud. Our compliance experts ensure that your cloud setup adheres to industry-specific regulations.We understand that cloud costs can spiral out of control. Our cost optimization strategies help you eliminate wastage and only pay for the resources you need, reducing your cloud bills significantly.Our team is always watching over your cloud infrastructure, 24/7.We create robust disaster recovery and backup plans to safeguard your data and applications. In case of unforeseen events, your business continuity is our priority.
              </p>
              <Link
                href="contact-us-1"
      ...
      <div className="service-section cloud-managed">
