...
const webApp = () => {
  ...
  return (
    ...
    <div className={`whats-app-icon ${scrolled ? "d-block" : "d-none"}`}> 
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h3 className="clr-light mb-3"> Web app Development </h3>
        ...
        <div className="container">
          <div className="row g-4">
            ...
            <div className="col-md-6">
              <p>
              Welcome to our Web Application Development Services! At Redtuf, we are passionate about transforming your ideas into dynamic and functional web applications. Our team of experienced developers and designers is here to collaborate with you, delivering custom solutions that drive innovation and help you achieve your business goals.
              </p>
            </div>
            <div className="col-md-6">
              <p className="mb-8">
      ...
      <div className="service-section web-app">
