          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-md-9 col-lg-8 col-xxl-7">
                ...
                We have a sizable staff of experts.
                </span>
                <h2 className="mt-5 mb-5 text-center">
                  The outstanding staff that handles our company.
                </h2>
                <p className="text-center mx-auto t-short-para">
                Our staff works hard to help clients maintain or acquire best-in-class positions in their their corresponding fields.
                </p>
              </div>
            </div>
          </div>
