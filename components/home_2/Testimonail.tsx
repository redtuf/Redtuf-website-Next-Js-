...
const feedbackData = [
  {
    ...
    name: 'Peter Cooper',
    review: "Best freelance group!I regret not discovering point 2 solutions sooner after assessing several experiments for two years.I'm reluctant to write it because this collection is mine.This is a group project I worked on.",
    company: "Barone LLC."
  },
  {
    id: 2,
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-10 col-lg-8 col-xxl-7">
              ...
              opinions of our present customers
              </span>
              <h2 className="mt-5 mb-5 text-center">
              Don't believe anything we say. see what our clients are saying
              </h2>
              <p className="text-center mx-auto max-text-60">
              Here are just a few of our clients' comments. Never believe anything we say.View some of our former clients' testimonials to learn more about us.
              </p>
            </div>
          </div>
        </div>
