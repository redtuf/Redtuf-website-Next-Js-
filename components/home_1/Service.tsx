        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-10 col-xl-8">
              ...
              We offer top-notch IT services for your long-term prosperity.
              </h2>
              <p className="text-center mx-auto t-short-para">
              Our IT solutions and services are dependable and expertly performed. Let's turn the entrepreneurial dream become a reality
              </p>
            </div>
          </div>
        </div>
